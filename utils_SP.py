...
import random
import torch
from utility.response_selection import keyword_based_JL as keyword_based
    ...
    if dataset in ['reddit', 'gab']:
        ...
        for x, y, z in zip(xlist, ylist, zlist):
            ...
            for i in y.strip('[]').split(', '):
                ...
                Y_text.append(temp)
                line_num += 1
    elif dataset == 'conansp':     
        with open('./data/CONAN/CONANSP.json', 'r', encoding='utf-8') as file:
