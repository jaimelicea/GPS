...
def get_iterators(opt, path, fname):
    spanish_fasttext_vectors = Vectors(name='./data/spanish_fasttext.vec')
    ...
    text_field.build_vocab(train_data, val_data, max_size=opt.n_vocab-4, vectors=spanish_fasttext_vectors)
